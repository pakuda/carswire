...
public class CarswireTestContainer extends TestContainer {

    public CarswireTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/carswire/app.properties",
    ...
    public static class Common extends CarswireTestContainer {

        public static final CarswireTestContainer.Common INSTANCE = new CarswireTestContainer.Common();
